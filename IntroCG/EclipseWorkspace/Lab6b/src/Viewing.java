...
public class Viewing
{
    ...
    private float cwLeft = -1.0f;
    private float cwRight = 1.0f;
    private float cwTop = 1.0f;
    private float cwBottom = -1.0f;
    private float cwNear =3.0f;
    private float cwFar = 100.5f;
    ...
    public void setUpFrustum( int program, GL3 gl3 )
    {
        ...
        gl3.glUniform1f( leftLoc,   cwLeft );
        gl3.glUniform1f( rightLoc,  cwRight );
        gl3.glUniform1f( topLoc,    cwTop );
        gl3.glUniform1f( bottomLoc, cwBottom );
        gl3.glUniform1f( nearLoc,   cwNear );
        gl3.glUniform1f( farLoc,    cwFar );
    }
